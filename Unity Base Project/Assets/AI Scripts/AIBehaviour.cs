...
public enum AI_STATE { IDLE, PATROL, MOVE_TO_PLAYER, TURN_TO_PLAYER, SLASH_LEFT, SLASH_RIGHT, SLASH_TOP, THRUST, GUARD_LEFT, GUARD_RIGHT, GUARD_TOP, DODGE, WINDOW_OF_OPPORTUNITY };
